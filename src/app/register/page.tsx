      ...
      <div className="relative hidden overflow-hidden bg-[oklch(0.28_0.05_210)] lg:flex lg:w-[48%] lg:flex-col lg:justify-between lg:p-10 xl:p-12">
        ...
        <div className="relative z-10 max-w-md space-y-4 text-white">
          ...
          <p className="text-white/70 text-sm leading-relaxed">
            Create an account, connect your social profiles, and ship content without the busywork.
          </p>
        </div>
        <p className="relative z-10 text-xs text-white/40">No credit card required to get started</p>
      </div>
        ...
        <div className="mx-auto w-full max-w-md">
          ...
          <div className="rounded-2xl border bg-card p-6 shadow-sm sm:p-8">
            <div className="mb-6 space-y-1">
              ...
              <p className="text-muted-foreground text-sm">Set up MastPlayer in a few steps.</p>
            </div>
            <form className="space-y-4" onSubmit={onSubmit}>
              ...
              <div className="space-y-2">
                ...
                <Input id="timezone" className="h-10" {...register("timezone")} />
              </div>
              {formError ? (
            ...
            <p className="text-muted-foreground mt-6 text-center text-sm">
              ...
              <Link className="text-foreground font-medium underline-offset-4 hover:underline" href="/login">
                Sign in
              </Link>
            </p>
          </div>
